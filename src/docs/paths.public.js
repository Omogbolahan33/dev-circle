...
const paths = {
  ...
  '/users/readiness': {
    get: op({
      ...
      description: [
        'Evaluates completion of the member information their circles need, across 3 staged rings:',
        '',
        '1. **Profile Details** — about them',
        '2. **Available Time** — when to reach them',
        '3. **Reachability & Consent** — how to reach them',
        '',
        'What sits *inside* those rings is not a fixed list. Eight properties are asked of every',
        'member regardless — name, phone, company, work sector, days, time window, channels and',
        'consent. Beyond those, a property is only asked for when an **active onboarding form in a',
        'circle the member belongs to is configured to collect it**: a circle that asks applicants',
        'where they work has a ring task for it, and a circle that never asks about gender never',
        'nags anybody about it.',
        '',
        'That is what closes the loop with onboarding. A form is a circle saying what it needs to',
        'know; anything it asked for and did not get — because the applicant skipped an optional',
        'question, or because they arrived by spreadsheet, by Developer Hub SSO or through the',
        'landing page, none of which collect much — becomes something the member is asked to',
        'finish themselves.',
        '',
        'Tasks carry `asked_by_circle` so a screen can tell the two apart. "Everyone needs this"',
        'and "your circle asks for this" are different sentences, and being told the wrong one is',
        'how a prompt reads as arbitrary.',
        '',
        'Closing a form stops it asking. A property no member can edit — the Developer Hub id — is',
        'never made a task, because a prompt with nowhere to go is worse than no prompt.',
        '',
