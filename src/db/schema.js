// ─── Base schema ────────────────────────────────────────────
// The tables as they were on day one. Everything since ships as a numbered
// migration, so this file is never edited to change a column — it is only what
// an empty database starts from.
//
// It lives apart from db/index.js because two databases are built from it now:
// the live one, and the throwaway the API sandbox runs against.
